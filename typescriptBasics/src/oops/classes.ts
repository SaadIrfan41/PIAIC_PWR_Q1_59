...
//? 1: Types dont support Declaration Merging

type personType = {
  firstname: string
  lastname: number
}
// This will give error because of same name
...
// This will work because interface support Declaration Merging
// interface personTypes {
//   dob: string
//   age: number
// }

//? 2: Interface support Extensibility

// Interfaces support extends and implements, while types don't. You can extend an interface with extends and implement it with implements
...
// You cant Extends Types using the extends keyword u have to use '&' or '|' to create a union of types

// This is not allowed
// type SquareType extends ShapeType = {
//   sideLength: number
// }
